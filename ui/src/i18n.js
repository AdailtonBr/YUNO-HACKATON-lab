...
const pt = {
  ...
  energy: {
    ...
    field: { submarket: "Submercado", source: "Fonte", structure: "Estrutura de preço", term: "Prazo máximo (meses)", volume: "Volume máximo (MWh)", total: "Valor máximo do contrato", discount: "Desconto mínimo vs curva (%)", uses: "Máximo de contratos",
      ...
      untilPast: "escolha uma data futura — um mandato que já nasce vencido é ruído no registro, não autorização", coverageMin: "Cobertura mínima da carga (%)", coverageMax: "Cobertura máxima da carga (%)", flexibility: "Flexibilidade mínima (%)", takeOrPay: "Take-or-pay máximo (%)", pld: "Exposição máxima ao PLD", rating: "Rating mínimo aceito", operation: "Operação permitida", netSaving: "Escalar acima de economia líquida", payment: "Meio de liquidação", cents: "Guardado em centavos para a decisão ser exata." },
